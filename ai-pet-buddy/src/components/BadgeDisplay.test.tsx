...
describe('BadgeDisplay', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render unlocked badge correctly', () => {
      ...
      expect(screen.getByText('A test badge that is unlocked')).toBeInTheDocument();
    ...
    it('should render locked badge correctly', () => {
      ...
      expect(screen.getByText('A test badge that is locked')).toBeInTheDocument();
    ...
    it('should show progress bar for locked badges', () => {
      ...
      const progressBar = document.querySelector('.badge-display__progress-bar');
  ...
  describe('Size Variants', () => {
    it('should apply small size class', () => {
      const { container } = render(<BadgeDisplay badge={mockUnlockedBadge} size="small" />);
    ...
    it('should apply large size class', () => {
      const { container } = render(<BadgeDisplay badge={mockUnlockedBadge} size="large" />);
  ...
  describe('Rarity Styling', () => {
    ...
    it('should apply rarity class for legendary badge', () => {
      const legendaryBadge = { ...mockUnlockedBadge, rarity: 'legendary' as const };
  ...
  describe('Description Display', () => {
    ...
    it('should hide description when showDescription is false', () => {
      render(<BadgeDisplay badge={mockUnlockedBadge} showDescription={false} />);
      
      expect(screen.queryByText('A test badge that is unlocked')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Click Handling', () => {
    ...
    it('should apply clickable class when onClick is provided', () => {
      const handleClick = vi.fn();
      const { container } = render(<BadgeDisplay badge={mockUnlockedBadge} onClick={handleClick} />);
  ...
  describe('Category Icons', () => {
    ...
    it('should display correct icon for evolution category', () => {
      const evolutionBadge = { ...mockUnlockedBadge, category: 'evolution' as const };
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle badge with 100% progress but not unlocked', () => {
      const completeBadge = { ...mockLockedBadge, progress: 1, unlocked: false };
    ...
    it('should handle empty or missing description', () => {
      ...
      render(<BadgeDisplay badge={badgeWithoutDescription} showDescription={true} />);
